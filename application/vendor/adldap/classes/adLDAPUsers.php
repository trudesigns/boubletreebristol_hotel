...
class adLDAPUsers {
    ...
    */
    public function info($username, $fields = NULL, $isGUID = false)
    {
     ...
     //   echo "INFO BIND: ".$this->adldap->getLdapBind();
...
//      echo "<pre>";
       // print_r($this->adldap->getBaseDn());
//    
       // echo "RESOURCE:<br />";
     // print_r($this->adldap->getLdapConnection());
      //print_r($filter);
         //print_r($fields);
//       exit;
         $ldap = Kohana::$config->load('ldap')->get('ldap');

        $sr = ldap_search($this->adldap->getLdapConnection(), $ldap['base_dn'], $filter,$fields);
