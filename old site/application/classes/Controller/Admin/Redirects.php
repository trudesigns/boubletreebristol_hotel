...
class Controller_Admin_Redirects extends Controller_Admin {
          public $user;
          public $acl = [
           "index"          => ["redirects"]
           ,"create"        => ["redirects"]
    ...
    public function action_index() {
           $view = new View('yellowbrick/pages/redirects/list');
           $q = ORM::factory('Redirect')->find_all();
            $view->redirects = $q;
                ...
                //process post data (if applicable)
                   if ($p->check()) {
                       $this->user = (object)$this->user;
                        ...
                        $view->msg = "The Redirect has been created/updated...";
                  //      exit;
                    }  else {

                        $view->post = $post;
                       $view->msg = "The Redirect you are creating/modifing has problems.";
    //                    //collect the errors, run them through /application/messages/[file] for pretty output
                       $view->errors = $post->errors('forms/redirect_errors');
    //                
                    }
